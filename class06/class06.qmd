...
We will grade a whole class of student assignments. We will always try to start with a simplified version of thew problem.
...
I can use the minus syntax trick to get everthing but the element with the min value.
...
Google and Claude told me about the `is.na()` function. Lets see how it work.
